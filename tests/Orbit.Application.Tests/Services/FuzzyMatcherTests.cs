...
public class FuzzyMatcherTests
{
    ...
    public void FuzzyContains_ShortTerm_ExactOnly()
    {
        ...
        FuzzyMatcher.FuzzyContains("go running", "ge").Should().BeFalse();    }
    ...
    [InlineData("Morning meditation", "meditaton", true)]    [InlineData("Exercise daily", "exercis", true)]
    [InlineData("Walk the dog", "walking", false)]    [InlineData("Drink water", "drink", true)]
