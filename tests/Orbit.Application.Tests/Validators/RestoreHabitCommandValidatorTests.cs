...
public class RestoreHabitCommandValidatorTests
{
    private readonly RestoreHabitCommandValidator _validator = new();

    private static RestoreHabitCommand ValidCommand() => new(
        UserId: Guid.NewGuid(),
