...
deduped. They are mirrored BY HAND. Nothing machine-compares them: the lockstep tool and its
CI check were both removed in the 2026-08-04 harness rebuild, so an unmirrored edit here now
turns nothing red. Change a phase here and mirror it there in the same task. Known intentional
