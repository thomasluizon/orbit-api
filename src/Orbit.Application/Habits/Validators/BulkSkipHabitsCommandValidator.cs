...
public class BulkSkipHabitsCommandValidator : AbstractValidator<BulkSkipHabitsCommand>
{
    public BulkSkipHabitsCommandValidator()
    {
        ...
        RuleFor(x => x.Items)
            ...
            .WithMessage($"Bulk skip cannot exceed {AppConstants.MaxBulkOperationSize} items");
