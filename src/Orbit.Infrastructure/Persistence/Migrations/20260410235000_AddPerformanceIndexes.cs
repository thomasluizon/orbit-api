    ...
    public partial class AddPerformanceIndexes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                CREATE INDEX CONCURRENTLY IF NOT EXISTS "IX_Habits_Reminder"
            ...
            migrationBuilder.Sql("""
                CREATE INDEX CONCURRENTLY IF NOT EXISTS "IX_Habits_DueDateAdvancement"
            ...
            migrationBuilder.Sql("""
                CREATE INDEX CONCURRENTLY IF NOT EXISTS "IX_Habits_SlipAlert"
        ...
        {
            migrationBuilder.Sql("""DROP INDEX CONCURRENTLY IF EXISTS "IX_Habits_Reminder";""");
            migrationBuilder.Sql("""DROP INDEX CONCURRENTLY IF EXISTS "IX_Habits_DueDateAdvancement";""");
            migrationBuilder.Sql("""DROP INDEX CONCURRENTLY IF EXISTS "IX_Habits_SlipAlert";""");
        }
    }
}
