...
public class GlobalRulesSection : IPromptSection
{
    ...
    public string Build(PromptContext context)
    {
        ...
        sb.AppendLine("""
            ...
            5. ACTION-ORIENTED: When the user's intent is clear (e.g., "I need to meditate every day", "create a reading habit"), act immediately by calling the appropriate tool. Do NOT ask for confirmation or permission to do what was explicitly requested. Only ask clarifying questions when the request is genuinely ambiguous (e.g., "help me with my habits" - unclear which action).
