...
public class GlobalRulesSection : IPromptSection
{
    ...
    public string Build(PromptContext context)
    {
        ...
        sb.AppendLine("""
            ...
            4. DUPLICATE PREVENTION: Before creating a habit or goal, silently check the indexes already provided above. If a very similar habit or goal already exists, mention it briefly and ask if they want a new one or to update the existing. If no duplicate exists, create it immediately. NEVER ask the user for permission to check for duplicates - you already have the list.
